...
namespace chessTeliki
{
    public class Database
    {
       public  Database(string user1,string user2,string date)
        {
            SqlConnection connection = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\USERS\DIMOL\DOWNLOADS\CHESSAAE\CHESSTELIKI\DATABASE1.MDF;Integrated Security = True; Connect Timeout = 30;");
